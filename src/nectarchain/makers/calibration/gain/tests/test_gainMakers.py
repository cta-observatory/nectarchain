...
from nectarchain.makers.calibration.gain.gainMakers import GainMaker
import numpy as np
...
class TestGainMaker:
    ...
    # Tests that an instance of GainMaker can be created with a list of pixel ids as input.
    ...
    def test_get_copy_of_result_table(self):
        ...
        assert np.array_equal(result_table_copy[GainMakerforTest.PIXELS_ID_COLUMN], np.array(pixel_ids))
