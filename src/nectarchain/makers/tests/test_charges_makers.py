                ...
                with tempfile.TemporaryDirectory() as tmpdirname:
                    ...
                    if (
                        ...
                        if _events_per_slice is None and _max_events is None:
                            ...
                            assert (
                                output.charges_lg.min()
                                == self.RUNS["charges_lg_min"][i]
                            )
                            assert (
                                output.charges_lg.max()
                                == self.RUNS["charges_lg_max"][i]
                            )
                            assert (
                            ...
                            assert (
                                output.charges_hg.min()
                                == self.RUNS["charges_hg_min"][i]
                            )
                            assert (
                                output.charges_hg.max()
                                == self.RUNS["charges_hg_max"][i]
                            )
                            assert (
