try:
    ...
    from ctapipe_io_nectarcam import EventSource, NectarCAMEventSource, TriggerBits
...
def GetLongRunTimeEdges(run, path=None, event_type=None, delta_t_second=10.0):
    # print(path)
    if path is None:
        path = GetDefaultDataPath()
