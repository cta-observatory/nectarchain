...
python flatfield_source_characterization.py --FF_run_number 6729 --SPE_run_number 6774  --SPE_config nominal --method LocalPeakWindowSum --extractor_kwargs '{"window_shift": 4, "window_width":8}'