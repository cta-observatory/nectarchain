...
#          assert np.allclose(loaded_waveform_container.wfs_hg,
#                             waveform_container.wfs_hg)
#          assert np.allclose(loaded_waveform_container.wfs_lg,
#                             waveform_container.wfs_lg)
